...
A virtual home lab is an affordable and safe way to practice and explore IT concepts like networking, cybersecurity, or system administration. It provides the flexibility to test different setups and configurations without the need for physical devices.
...
<li>Downloading Your operating systems ISO</li>	
...
<img src="folder/virtual home machine.png">
...
Download Oracle VM VirtualBox by <a href="https://download.virtualbox.org/virtualbox/7.1.4/VirtualBox-7.1.4-165100-Win.exe"=blank">clicking here</a>. Once the download completes, I launched the installation.
